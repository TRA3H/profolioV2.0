...
import { GlobeAltIcon, ChevronRightIcon, ArrowLeftIcon } from "@heroicons/react/24/outline";
...
const Project = ({ title, description, gh_url, proj_url}: Props) => {
  ...
  return (
    <motion.div
      ...
      className="card relative flex flex-col overflow-hidden rounded-md border border-white/20 bg-white/5"
      style={
        {
              ...
              <div className="flex justify-between">
                {gh_url && (
                  <a
                    ...
                    rel="noreferrer"
                    href={gh_url}
                    className="flex items-center space-x-2 rounded-full bg-gray-800 p-2 pr-2 transition-transform hover:scale-95 sm:pr-4"
                  >
